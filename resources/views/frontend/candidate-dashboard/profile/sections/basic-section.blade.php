            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <label class="font-sm color-text-mutted mb-10">CV *
                        <span class="text-primary">({{ $candidate?->cv ? 'Have attached cv.' : '' }})</span></label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="experience_level"
                                class="{{ $errors->has('experience_level') ? 'is-invalid' : '' }} form-control form-icons select-active select2">
