                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                    <div class="content-single">
                        ...
                        <div class="dashboard_overview">
                            ...
                            @if (!\App\Helpers\isCandidateProfileComplete())
                                <div class="row">
                                    <div class="col-12 mt-30">
                                        <div class="dash_alert_box p-30 bg-danger rounded-4 d-flex flex-wrap">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>You can not access all the features of the website if you don't setup
                                                    your account first make sure you setup your Basic, Profile and Account
                                                    Seeting Data.</p>
                                            </div>
