                    ...
                    <div class="swiper-slide">
                        @foreach ($companies as $company)
                            <div class="item-5 hover-up wow animate__animated animate__fadeIn"><a
                                    href="{{ route('company.show', $company->slug) }}">
                                    <div class="item-logo">
                                        <div class="image-left"><img alt="{{ $company->name }}"
                                                src="{{ $company->logo }}">
                                        </div>
                                        ...
                                        <div class="text-info-bottom mt-5"><span
                                                class="font-xs color-text-mutted icon-location">{{ App\Helpers\formatLocation($company->companyCountry->name) }}</span><span
