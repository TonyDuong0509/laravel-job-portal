                        ...
                        <form action="{{ route('company.jobs.update', $job->id) }}" method="POST">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <p><a href="{{ route('company.jobs.index') }}"><- Back</a></p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="category"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'category') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="country"
                                                    class="form-control form-icons select-active country {{ \App\Helpers\hasError($errors, 'country') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="state"
                                                    class="form-control form-icons select-active state {{ \App\Helpers\hasError($errors, 'state') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="city"
                                                    class="form-control form-icons select-active city {{ \App\Helpers\hasError($errors, 'city') }}">
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group d-flex">
                                                        <input @checked($job->salary_mode === 'range')
                                                            ...
                                                            id="salary_range"
                                                            class="{{ \App\Helpers\hasError($errors, 'salary_mode') }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="salary_type"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'salary_type') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="experience"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'experience') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="job_role"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'job_role') }}">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="education"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'education') }}">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="job_type"
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'job_type') }}">
                                                    <option value="">Select</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="tags[]" multiple
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'tags') }}">
                                                    @php
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group select-style">
                                                ...
                                                <select name="skills[]" multiple
                                                    class="form-control form-icons select-active {{ \App\Helpers\hasError($errors, 'skill') }}">
                                                    @php
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group d-flex">
                                                        <input @checked($job->featured) type="checkbox"
                                                            id="featured"
                                                            class="{{ \App\Helpers\hasError($errors, 'featured') }}"
                                                            name="featured" checked style="height: 18px; width: 18px;">
                                                        <label style="margin-left: 5px; margin-top: -4px"
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group d-flex">
                                                        <input @checked($job->highlight) type="checkbox"
                                                            id="highlight"
                                                            class="{{ \App\Helpers\hasError($errors, 'highlight') }}"
                                                            name="highlight" style="height: 18px; width: 18px;">
                                                        <label style="margin-left: 5px; margin-top: -4px"
