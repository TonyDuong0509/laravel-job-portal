                                ...
                                <div class="filter-block mb-30">
                                    ...
                                    <div class="filter-block mb-30">
                                        <div class="form-group select-style">
                                            ...
                                            <button class="submit btn btn-default mt-10 rounded-1 w-100" type="submit">
                                                Search
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="box-border"><span class="text-sortby">Sort by:</span>
                                            <div class="dropdown dropdown-sort">
                                                <button class="btn dropdown-toggle" id="dropdownSort2" type="button"
                                                    ...
                                                    <span>Newest Post</span><i class="fi-rr-angle-small-down"></i></button>
                                                <ul class="dropdown-menu dropdown-menu-light"
                                    ...
                                    <div class="card-grid-2 hover-up">
                                        <div class="card-grid-2-image-left d-flex ">
                                            <div class="card-grid-2-image-rd online"><a
                                                    href="{{ route('candidate.show', $candidate->slug) }}">
                                                    <figure><img alt="joblist" src="{{ $candidate->image }}">
                                                    </figure>
                                                </a></div>
                                            <div class="card-profile pt-10">
                                                <a href="{{ route('candidate.show', $candidate->slug) }}">
                                                    <h5>{{ $candidate->full_name }}</h5>
                                                </a>
                                                <span class="font-xs color-text-mutted">{{ $candidate->title }}</span>
                                                <div class="rate-reviews-small pt-5">
                                                    @if ($candidate->status === 'available')
                                                        <p class="font-lg color-text-paragraph-2"><b>I am available</b></p>
                                                    @endif
                                                    {{-- <span>
                                                        <img src="../../../public/frontend/assets/imgs/template/icons/star.svg"
                                                            alt="joblist">
                                                    </span>
                                                    <span>
                                                        <img src="../../../public/frontend/assets/imgs/template/icons/star.svg"
                                                    ...
                                                    <div class="col-6"><span
                                                            class="d-flex justify-content-end align-items-center"><span
                                                                class="font-sm"><a href=""
                                                                    class="text-primary">View Resume</a></span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
