    ...
    <section class="section-box-2">
        <div class="container">
            <div class="banner-hero banner-image-single"><img style="height: 374px; object-fit:cover"
                    src="{{ $company->banner }}" alt="{{ $company->name }}"></div>
            <div class="box-company-profile">
                <div class="row mt-10">
                    <div class="col-lg-8 col-md-12">
                        <div>
                            <img style="width: 100px; height: 100px; object-fit: cover" src="{{ $company->logo }}"
                                alt="{{ $company->name }}">
                        </div>
                        <h5 class="f-18">{{ $company->name }} <span
                                class="card-location font-regular ml-20">{{ App\Helpers\formatLocation($company->companyCountry->name, $company->companyState->name, $company->companyCity->name) }}</span>
                        </h5>
                    </div>
                    <div class="col-lg-4 col-md-12 text-lg-end"><a class="btn btn-apply btn-apply-big" href="javascript:;"
                            onclick="document.getElementById('open-position').scrollIntoView()">Open Position</a></div>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-2-image-left">
                                                    ...
                                                    <div class="right-info">
                                                        <a class="name-job"
                                                            href="{{ route('company.show', $job->company->slug) }}">{{ $job->company->name }}</a><span
                                                            class="location-small">{{ \App\Helpers\formatLocation($job->company->companyCountry->name, $job->company->companyState->name, $job->company->companyCity->name) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="sidebar-text-info"><span class="text-description">Industry Type
                                        </span><strong class="small-heading">{{ $company->industryType->name }}</strong>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="sidebar-text-info"><span class="text-description">Establishment Date
                                        </span><strong class="small-heading">{{ $company->establishment_date }}</strong>
                                    </div>
                                </li>
                                <li>
