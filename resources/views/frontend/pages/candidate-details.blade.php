    ...
    <section class="section-box-2">
        <div class="container">
            <div class="banner-hero banner-image-single"><img
                    style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%" src="{{ $candidate->image }}"
                    alt="{{ $candidate->name }}">
            </div>
                ...
                <div class="row mt-10">
                    ...
                    @if ($candidate->cv)
                        <div class="col-lg-4 col-md-12 text-lg-end"><a class="btn btn-download-icon btn-apply btn-apply-big"
                                href="{{ $candidate->cv }}">Download CV</a></div>
                    @endif
                </div>
            </div>
                                        ...
                                        @foreach ($candidate->experiences as $experience)
                                            <li>
                                                <a href="#" class="float-right">
                                                    {{ $experience->start }} -
                                                    {{ $experience->currently_working ? 'Current' : $experience->end }}
                                                </a>
                                                <a href="javascript:;"><b>{{ $experience->designation }}</b> |
                                                    <span>{{ $experience->department }}</span></a>
                                    ...
                                    <ul class="timeline">
                                        @foreach ($candidate->educations as $education)
                                            <li>
                                                ...
                                                <a href="javascript:;"><b>{{ $education->level }}</b></a>
                    ...
                    <div class="sidebar-border">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="sidebar-text-info"><span class="text-description">Date of
                                            Birth</span><strong class="small-heading">{{ $candidate->birth_date }}</strong>
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="sidebar-list-job">
                            <ul class="ul-disc">
                                ...
                                <li>Phone 1: {{ $candidate->phone_one }}</li>
                                <li>Phone 2: {{ $candidate->phone_two }}</li>
