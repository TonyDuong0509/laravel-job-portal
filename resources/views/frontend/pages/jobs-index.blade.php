                    ...
                    <div class="sidebar-shadow none-shadow mb-30">
                        <div class="sidebar-filters">
                            <div class="filter-block head-border mb-30">
                                <h5>
                                    Advance Filter
                                    <a class="link-reset" href="{{ route('jobs.index') }}">Reset</a>
                                </h5>
                            </div>
                            ...
                            <form action="{{ route('jobs.index') }}" method="GET">
                                ...
                                <button class="submit btn btn-default rounded-1 w-100" type="submit">
                                    Search
                                </button>
                            </form>
