            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                               class="form-control {{ \App\Helpers\hasError($errors, 'site_name') }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email"
                               class="form-control {{ \App\Helpers\hasError($errors, 'site_email') }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text"
                               class="form-control {{ \App\Helpers\hasError($errors, 'site_phone') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="site_default_currency"
                            ...
                            @foreach(config('currencies.currency_list') as $key => $currency)
                                <option
                                    @selected(config('settings.site_default_currency') === $currency) value="{{ $currency }}">{{ $currency }}</option>
                            @endforeach
                        </select>
