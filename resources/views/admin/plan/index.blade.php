...
@section('contents')
    <section class="section">
        ...
        <div>
            <a class="btn btn-primary ml-2 mb-5" href="{{ route('admin.plans.create') }}">
                                    ...
                                    <div class="pricing">
                                        ...
                                        <div class="pricing-padding">
                                            ...
                                            <div class="pricing-details">
                                                <div class="pricing-item">
                                                    ...
                                                    <div class="pricing-item-label">{{ $plan->job_limit }} Job Post Limit
                                                    </div>
                                                </div>
                                                <div class="pricing-item">
                                                    <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                                                    <div class="pricing-item-label">{{ $plan->featured_job_limit }} Featured
                                                        Job Post Limit</div>
                                                </div>
                                                <div class="pricing-item">
                                                    <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                                                    <div class="pricing-item-label">{{ $plan->highlight_job_limit }}
                                                        Highlight Job Post</div>
                                                </div>
                                                <div class="pricing-item">
                                                    @if ($plan->profile_verify)
                                                        <div class="pricing-item-icon"><i class="fas fa-check"></i></div>
                                                    @else
                                                        <div class="pricing-item-icon bg-danger"><i
                                        ...
                                        <div class="pricing-cta"
                                            ...
                                            <a href="{{ route('admin.plans.edit', $plan->id) }}"
                                                class="w-100 bg-primary text-light">Edit <i
